...
- Copy brief: writes a complete `ReliefGrid dispatch brief` to the browser clipboard.
...
- Devpost handoff: 7 copy buttons, screenshot media, WebM video preload, pitch deck link, and category/fit copy all work.
